        ...
        <div class="col-sm">
            <div class="card">
              <div class="card-body">
                ...
                <h5 class="text-muted text-center">1,2-hydride shift of 2-methylbutyl cation</h5>
                <!-- <p class="text-left">&nbsp;&nbsp;&nbsp;&nbsp; E2 elimination.</p>  -->
                <p style="text-align:center;">
                <img src="{{site.baseurl}}/assets/images/normal/hshift-mechanism.jpg" alt="centered image" style="width:750px;height:214px;">
                </p>
              </div>
            </div>
        </div> 
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h5 class="text-muted text-center">Major trajectory</h5>
                <p style="text-align:center;">
                <img src="{{site.baseurl}}/assets/images/normal/Hshift_traj1-1.gif" alt="centered image" style="width:600px;height:480px;">
                </p>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h5 class="text-muted text-center">IRC of the reaction</h5>
                <p style="text-align:center;">
                <img src="{{site.baseurl}}/assets/images/normal/hshift_IRC_loop.gif" alt="centered image" style="width:600px;height:336px;">
                </p>
          </div>
        </div>
      </div> 
