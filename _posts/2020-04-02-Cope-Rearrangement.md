        ...
        <div class="col-sm">
            <div class="card">
              <div class="card-body">
                ...
                <h5 class="text-muted text-center">Cope rearrangement of 1,5 hexadiene</h5>
                <!-- <p class="text-left">&nbsp;&nbsp;&nbsp;&nbsp; E2 elimination.</p>  -->
                <p style="text-align:center;">
                <img src="{{site.baseurl}}/assets/images/normal/cope-mechanism.jpg" alt="centered image" style="width:600px;height:214px;">
                </p>
              </div>
            </div>
        </div> 
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h5 class="text-muted text-center">Major trajectory</h5>
                <p style="text-align:center;">
                <img src="{{site.baseurl}}/assets/images/normal/Cope_traj1-0.gif" alt="centered image" style="width:600px;height:480px;">
                </p>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h5 class="text-muted text-center">IRC of the reaction</h5>
                <p style="text-align:center;">
                <img src="{{site.baseurl}}/assets/images/normal/Cope_IRC_loop.gif" alt="centered image" style="width:600px;height:336px;">
                </p>
          </div>
        </div>
      </div> 
